...
while True:
    user = api.get_user('HariniS32897714')
    api.update_profile(name=f'harini|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : harini|{follower_count(user)} Followers')
